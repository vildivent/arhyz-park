...
export default function Privacy() {
  return (
    <Container className="max-w-7xl items-start [&_h2]:font-p [&_h2]:text-2xl [&_h2]:font-semibold [&_h3]:font-p">
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые ООО «АрхызПарк» (далее
        — Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        Оператор может получить о посетителях веб-сайта https://arhyzpark.ru.
      </p>
      ...
      <p>
        ...
        сети интернет по сетевому адресу https://arhyzpark.ru.
      </p>
      <p>
      ...
      <p>
        2.10. Пользователь — любой посетитель веб-сайта https://arhyzpark.ru.
      </p>
      <p>
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора ooo-ap@bk.ru с пометкой
      ...
      <p>
        ...
        электронной почты на электронный адрес Оператора ooo-ap@bk.ru с пометкой
      ...
      <p>
        ...
        Оператору с помощью электронной почты ooo-ap@bk.ru.
      </p>
      <p>
      ...
      <p>
        ...
        Интернет по адресу https://arhyzpark.ru/privacy-policy.
      </p>
    </Container>
  );
}
